...
// Class Description:
//
// Provides a self-managing wrapper class for common CURL functions

#ifndef InetRetriever_H_
#define InetRetriever_H_
...
public:
   ...
   *  Constructor
   *
   * targURL:   The URL, including protocol designation, of the target to be retrieved.
   ...
   */
  InetRetriever(const std::string& targURL) throw(int);
...
private:
  ...
  std::string   _targetURL, _curlBuffer, _fileCache;
  long          _lastModTime;
